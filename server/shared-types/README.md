...
기계가 읽고 검증할 수 있는 명세는 [`openapi/openapi.yaml`](openapi/openapi.yaml)에 있습니다. JPEG 미디어 등록·완료·재시도·조회 계약은 포함하며, 아직 상세 형식이 확정되지 않은 미디어 집합 확정, 관찰, 리포트, 메모와 AI 실패 결과 API는 제외합니다.
